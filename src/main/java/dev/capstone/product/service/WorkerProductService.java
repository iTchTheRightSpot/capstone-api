...
import dev.capstone.exception.*;
import dev.capstone.product.dto.CreateProductDTO;
import dev.capstone.product.dto.PriceCurrencyDto;
import dev.capstone.product.dto.UpdateProductDTO;
import dev.capstone.product.entity.PriceCurrency;
import dev.capstone.product.entity.Product;
import dev.capstone.product.projection.ProductPojo;
import dev.capstone.product.repository.PriceCurrencyRepo;
...
import static dev.capstone.enumeration.SarreCurrency.NGN;
import static dev.capstone.enumeration.SarreCurrency.USD;
