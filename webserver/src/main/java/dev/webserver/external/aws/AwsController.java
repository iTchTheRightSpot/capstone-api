...
import dev.webserver.product.ProductImageRepository;
import dev.webserver.product.ProductRepository;
...
class AwsController {
    ...
    public String testControl() {
        ...
        final var productKeys = productRepository.findAll().stream()
