...
final class EmployeeProductControllerTest extends AbstractIntegration {

    @Value(value = "/${api.endpoint.baseurl}employee/product")
    private String path;
    ...
    void allProducts() throws Exception {
        ...
        TestData.dummyProducts(category, 10, employeeProductService);
