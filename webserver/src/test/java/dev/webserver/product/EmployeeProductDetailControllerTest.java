...
final class EmployeeProductDetailControllerTest extends AbstractIntegration {
    ...
    void shouldSuccessfullyCreateAProductDetail() throws Exception {
        ...
        var dto = TestData.productDetailDTO(list.getFirst().uuid(), "exon-mobile-colour", dtos);
